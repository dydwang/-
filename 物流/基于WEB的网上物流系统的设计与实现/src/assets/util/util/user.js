...
let commList='commList'
user.addcommList=function(data,callback) {
    util(add(commList,data),src,callback)
}
user.getcommList=function(data,callback) {
    util(get(commList,data),src,callback)
}
user.delcommList=function(data,callback) {
    util(del(commList,data),src,callback)
}
user.upcommList=function(data,callback) {
    util(up(commList,data),src,callback)
}
