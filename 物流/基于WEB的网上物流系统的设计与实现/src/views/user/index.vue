    ...
    <div id="index">
        <el-container>
            <el-header height="80px" >
                ...
                <div style="width: 10rem;height: 80px;float: left;line-height: 80px;font-weight: 600;color: #303133;font-size: 1.8rem">
                    网上物流系统
                </div>
                    ...
                    <el-row style="border-bottom: 1px solid #606266;padding-bottom: 2rem;margin-bottom: 1rem">
                        <el-col :span="24">
                            ...
                            <div style="margin: 0 auto;width: 520px;height: 20px">
                                <li class="lis">Q  Q: 245017115</li>
                                <li class="lis">邮箱: 245017115@qq.com</li>
                                <li class="lis">地址: 武汉东湖学院</li>
                            </div>
                        </el-col>
                    </el-row>

                    <div style="text-align: center">基于VUE+Element门户网站</div>
                </div>
            </el-footer>
        </el-container>
    </div>
