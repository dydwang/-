...
user.add=function(data,callback) {
    util(add(data.$table,data.$where),src,callback)
}
user.get=function(data,callback) {
    util(get(data.$table,data),src,callback)
}
user.del=function(data,callback) {
    util(del(data.$table,data.$where),src,callback)
}
user.up=function(data,callback) {
    util(up(data.$table,data),src,callback)
}
