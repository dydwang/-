...
user.delUser=function(data,callback) {
...
let payList='payList'
user.addPayList=function(data,callback) {
    util(add(payList,data),src,callback)
}
user.upPayList=function(data,callback) {
    util(up(payList,data),src,callback)
}
user.getPayList=function(data,callback) {
    util(get(payList,data),src,callback)
}
user.delPayList=function(data,callback) {
    util(del(payList,data),src,callback)
}
...
let cai_gou='cai_gou'
user.addCai=function(data,callback) {
    util(add(cai_gou,data),src,callback)
}
user.getCai=function(data,callback) {
    util(get(cai_gou,data),src,callback)
}
user.delCai=function(data,callback) {
    util(del(cai_gou,data),src,callback)
}
user.upCai=function(data,callback) {
    util(up(cai_gou,data),src,callback)
}

let cai_gou_list='cai_gou_list'
user.addCaiList=function(data,callback) {
    util(add(cai_gou_list,data),src,callback)
}
user.getCaiList=function(data,callback) {
    util(get(cai_gou_list,data),src,callback)
}
user.delCaiList=function(data,callback) {
    util(del(cai_gou_list,data),src,callback)
}
user.upCaiList=function(data,callback) {
    util(up(cai_gou_list,data),src,callback)
}


let cook_sort='cook_sort'
user.addCookSort=function(data,callback) {
    util(add(cook_sort,data),src,callback)
}
user.getCookSort=function(data,callback) {
    util(get(cook_sort,data),src,callback)
}
user.delCookSort=function(data,callback) {
    util(del(cook_sort,data),src,callback)
}
user.upCookSort=function(data,callback) {
    util(up(cook_sort,data),src,callback)
}
