...
let Hotel='hotel'
user.addHotel=function(data,callback) {
    util(add(Hotel,data),src,callback)
}
user.getHotel=function(data,callback) {
    util(get(Hotel,data),src,callback)
}
user.delHotel=function(data,callback) {
    util(del(Hotel,data),src,callback)
}
user.upHotel=function(data,callback) {
    util(up(Hotel,data),src,callback)
}
