<template>
    <div id="box">
        <el-button type="primary" round plain @click="dialogVisible=true;updates=false;openDia($JSP(ruleForm))">添加酒店</el-button>
        <el-dialog
...
<script>
    import createGoods from './createSort'
    ...
    export default {
        ...
        methods: {
            chagneTtstus(row,index){
                this.$api.delHotel({ids:row.ids},res=>{
                    if(res){
