            ...
            submitForm(){
                ...
                this.$ver(this.$refs.ruleForm).then(()=>{
                    if(!that.updates){
                        ...
                        that.$api.upHotel(this.ruleForm,res=>{
                            if(res){
