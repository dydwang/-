<template>
    <div id="box">
        ...
        <div style="margin-left: 15%;width: 60%;min-height: 30vh" v-html="query.content">

        </div>
        <dyd-video v-if="query.videoPath" :src="query.videoPath"></dyd-video>
        <dyd-pdf v-if="query.pdfPath" style="width: 60%;margin: 0 auto" :src="$nodeUrl+'getPdf?pdfPath='+query.pdfPath"></dyd-pdf>
    </div>
</template>
