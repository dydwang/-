    ...
    <div id="index">
        <el-container>
            <el-header height="80px" >
                ...
                <div style="width: 23rem;height: 80px;float: left;line-height: 80px;font-weight: 600;color: #303133;font-size: 1.8rem">
                    婚礼网站
                </div>
                ...
                <div style="float: right;font-size: 1.2rem;margin-right:2rem">
                    <el-tabs v-model="activeName" @tab-click="handleClickRouter" style="margin-top: 26px">
                        ...
                        <el-tab-pane label="喜车" name="/car"></el-tab-pane>
                        <el-tab-pane label="服装" name="/clothing"></el-tab-pane>
                        <el-tab-pane label="影视" name="/video"></el-tab-pane>
                        <el-tab-pane label="个人" name="/myInfo"></el-tab-pane>
                    </el-tabs>
                </div>
            </el-header>
            <el-main style="min-height: 70vh">
                ...
                <div style="margin: 0 auto;" id="we">
                    <el-row style="border-bottom: 1px solid #606266;padding-bottom: 2rem;margin-bottom: 1rem">
                        <el-col :span="24">
                            ...
                            <div style="margin: 0 auto;width: 620px;height: 20px">
                                <li class="lis">Q  Q: 1960038042</li>
                                <li class="lis">邮箱: 1960038042@qq.com</li>
                                <li class="lis">地址: 成都理工大学工程技术学院</li>
                            </div>
                        </el-col>
                    </el-row>

                    <div style="text-align: center">婚礼网站</div>
                </div>
            </el-footer>
        </el-container>
    </div>
