<template>
    <div id="box">
        ...
        <div style="margin-left: 15%;width: 70%;min-height: 10vh" v-html="query.content">

        </div>
        <dyd-video style="margin-bottom: 5vh" v-if="query.videoPath" :src="query.videoPath"></dyd-video>
