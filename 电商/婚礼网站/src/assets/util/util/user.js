...
let Cloth='Cloth'
user.addCloth=function(data,callback) {
    util(add(Cloth,data),src,callback)
}
user.getCloth=function(data,callback) {
    util(get(Cloth,data),src,callback)
}
user.delCloth=function(data,callback) {
    util(del(Cloth,data),src,callback)
}
user.upCloth=function(data,callback) {
    util(up(Cloth,data),src,callback)
}
