<template>
    <div id="box">
        ...
        <div style="margin-left: 15%;width: 70%;min-height: 30vh" v-html="query.content">

        </div>
        <dyd-video style="width: 80%;margin-left: 10%" v-if="query.videoPath" :src="query.videoPath"></dyd-video>
