<template>
    <div id="box">
        <el-button plain round type="primary" @click="dialogVisible=true;ruleForm=$JSP(form);update=false">  + 添加地点</el-button>

        <el-dialog
                :visible.sync="dialogVisible"
                width="40%">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="80px" class="demo-ruleForm">
                <el-form-item label="上课地点" prop="names">
        ...
        <el-table :data="tableData">
            ...
            <el-table-column prop="names" label="上课地点"></el-table-column>
