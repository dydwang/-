<template>
    <div id="work">
        <el-button round plain type="primary" @click="dialogVisible=true">发布测试</el-button>
        <el-dialog
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="测试名称" prop="names">
                    <el-input v-model="ruleForm.names"></el-input>
                </el-form-item>
                <el-form-item label="测试附件" prop="file">
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    names: [{ required: true, message: '请输入测试名称', trigger: 'blur' }],
        ...
        methods: {
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        this.$api.addTest(this.ruleForm,res=>{
                            if(res){
            ...
            delSort(index,row){
                this.$api.delTest({ids:row.ids},res=>{
