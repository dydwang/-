    ...
    <div id="index">
        <el-container>
            <el-header height="80px" >
                ...
                <div style="width: 18rem;height: 80px;float: left;line-height: 80px;font-weight: 600;color: #303133;font-size: 1.8rem">
                    课程学习管理系统
                </div>
                    ...
                    <el-row style="border-bottom: 1px solid #606266;padding-bottom: 2rem;margin-bottom: 1rem">
                        <el-col :span="24">
                            ...
                            <div style="margin: 0 auto;width:360px;height: 20px">
                                <li class="lis">Q  Q: 486182964</li>
                                <li class="lis">地址: 哈尔滨理工大学</li>
                            </div>
                        </el-col>
                    </el-row>

                    <div style="text-align: center">课程补习管理系统</div>
                </div>
            </el-footer>
        </el-container>
    </div>
